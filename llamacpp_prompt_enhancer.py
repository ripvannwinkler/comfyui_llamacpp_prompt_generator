...
STYLE_PROMPTS = {
    ...
    "skin texture": "Start the enhanced prompt with 'skin texture, '. Create a photorealistic portrait with extreme attention to skin realism. Detail every aspect of human skin texture: visible pores across the entire face and exposed skin, each pore rendered with precise depth and shadow, tiny skin ridges and furrows following natural skin topography, fine vellus hairs visible under close inspection, subtle skin imperfections including minor freckles, small moles, faint blemishes, and natural skin tone variations. Describe the micro-texture of skin including the pebbly surface of pores, the smooth inter-pore areas, and the natural oil sheen distribution. Include subsurface scattering effects where light penetrates the skin surface creating a natural translucency, especially noticeable at ear edges, nostril rims, and finger joints. Capture the realistic variation in skin texture between different facial zones: smoother forehead and chin, more textured nose and cheeks, finer texture around eyes and mouth. Describe natural skin details like tiny wrinkles around eyes (crow's feet), forehead lines, nasolabial folds, and perioral lines with precise anatomical accuracy. Include the natural moisture level of skin, subtle shine on high points (cheekbones, bridge of nose, cupid's bow), and the matte finish in low points. Specify how light interacts with the textured skin surface, creating micro-shadows in pores and highlighting skin ridges.",
}
