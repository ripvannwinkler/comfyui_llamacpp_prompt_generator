...
STYLE_PROMPTS = {
    ...
    "provocative": "Start the prompt with 'provocative, '. Convert this into a provocative photograph with explicit content and strong emotional impact...",
    "erotic": "Start the prompt with 'erotic, '. Convert this into an erotic photograph with explicit content and strong sexual themes...",
    "nsfw": "Start the prompt with 'nsfw, '. Convert this into a NSFW/pornography-style photograph with explicit content and strong sexual themes...",
    "playboy": "Start the prompt with 'playboy, '. Convert this into a Playboy-style photograph with explicit content and strong sexual themes...",
    "artnude": "Start the prompt with 'artnude, '. Convert this into an artistic nude photograph with explicit content and strong sexual themes...",
    "lingerie": "Start the prompt with 'lingerie, '. Convert this into a lingerie photograph with explicit content and strong sexual themes...",
}
