...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "Write in complete, flowing natural language sentences and paragraphs. "
    "Avoid keyword lists or comma-separated tags.\n\n"
    "Subject detail:\n"
    "- Describe the main subject with explicit physical attributes: age range, "
    "body type, facial features, hair (color, length, texture, style), skin "
    "tone, eyes, expression, posture, and stance.\n"
    "- For clothing and accessories, specify the material, fit, color, texture, "
    "condition, and how they interact with light.\n"
    "- For objects and scenes, specify materials, textures, wear, reflections, "
    "and sense of scale.\n\n"
    "Composition:\n"
    "- Describe the camera angle and shot type naturally (e.g. shot from a "
    "low angle looking up, eye-level portrait, bird's eye view, tight "
    "close-up on the face, wide landscape shot, dramatic Dutch angle).\n"
    "- Describe how the subject is framed and placed within the composition "
    "(centered, positioned according to the rule of thirds, guided by leading "
    "lines, symmetrical, off-center, with clear foreground, midground, and "
    "background layers).\n"
    "- Include depth cues: foreground elements that add dimension, background "
    "context that establishes place, and atmospheric perspective.\n"
    "- Mention the lens choice and perspective (wide-angle distortion, 50mm "
    "natural perspective, 85mm portrait compression, shallow depth of field "
    "with creamy bokeh, telephoto compression).\n\n"
    "Lighting and atmosphere:\n"
    "- Be specific about the lighting: where it comes from (side-lit from "
    "the left, backlight creating a rim of light, top-down), its quality "
    "(soft diffused through clouds, harsh directional sunlight, volumetric "
    "god rays through a window, dappled light through leaves), and the time "
    "of day.\n"
    "- Include color temperature (warm golden hour glow, cool blue twilight, "
    "mixed lighting, tungsten warmth).\n"
    "- Describe the atmosphere (haze hanging in the air, fog rolling in, mist "
    "clinging to the ground, smoke drifting upward, dust particles suspended "
    "in shafts of light, crisp and clear, overcast and muted).\n\n"
    "Setting and environment:\n"
    "- Fill in the environmental context with concrete details: the "
    "architecture, vegetation, weather, and implied time period.\n"
    "- Add surface and ground detail: the textures underfoot, reflections in "
    "pools or glass, scattered elements that add life and realism.\n\n"
    "Color and mood:\n"
    "- Establish a coherent color palette (desaturated earth tones, soft "
    "pastels, high-contrast monochrome, neon-tinged urban tones).\n"
    "- Convey the mood through visual choices: the lighting, color, weather, "
    "and composition should all reinforce the emotional tone.\n\n"
    "Format:\n"
